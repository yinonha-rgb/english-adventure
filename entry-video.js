...
(()=>{
  ...
  const src='assets/entry-welcome.mp4?v=4.42.8';
  ...
  const show=()=>{
    ...
    video.controls=true;
    const close=()=>{sessionStorage.setItem(seenKey,'1');page.remove();document.querySelector('.daily-start,#dailyLessonBtn')?.focus?.();};
