const VERSION='english-adventure-3.0.0';
const CORE=['./','./index.html','./app.js?v=3.0.0','./firebase-sync.js?v=3.0.0','./firebase-config.js','./content.json','./manifest.json','./update-manifest.json','./icon.svg','./icon-maskable.svg'];
