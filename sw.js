const VERSION='english-adventure-5.4.13';
...
CORE.push('./interactive-activity-engine.js?v=4.42.18');
CORE.push('./services/storage.js?v=4.43.0','./services/state.js?v=4.43.0','./app.js?v=4.43.0');
CORE.push('./classroom-tools.js?v=4.44.0','./interactive-activity-engine.js?v=4.44.0','./app.js?v=4.44.0');
CORE.push('./classroom-tools.js?v=4.44.1','./interactive-activity-engine.js?v=4.44.1','./app.js?v=4.44.1');
CORE.push('./accessibility-tools.js?v=4.45.0','./app.js?v=4.45.0');
CORE.push('./accessibility-tools.js?v=4.46.0','./app.js?v=4.46.0','./entry-video.js?v=4.46.0','./home-teacher-restore.js?v=4.46.0','./interactive-activity-engine.js?v=4.46.0','./teacher-ai.js?v=4.46.0','./teacher-noa-video.js?v=4.46.0','./teacher-rig.js?v=4.46.0','./teacher-system.js?v=4.46.0','./teacher-visual.js?v=4.46.0');
...
CORE.push('./app.js?v=4.48.0','./teacher-providers.js?v=4.48.0','./teacher-ai.js?v=4.48.0','./interactive-activity-engine.js?v=4.48.0');
...
CORE.push('./teacher-rig.js?v=5.3.1','./experience-redesign.js?v=5.3.1','./app.js?v=5.3.1');
CORE.push('./entry-video.js?v=5.3.1');
CORE.push('./interactive-activity-engine.js?v=5.3.2','./app.js?v=5.3.2','./entry-video.js?v=5.3.2');
CORE.push('./teacher-rig.js?v=5.3.3','./app.js?v=5.3.3');
CORE.push('./teacher-visual.js?v=5.4.1');
CORE.push('./teacher-system.js?v=5.4.2','./teacher-video-motion.js?v=5.4.3','./teacher-video-motion.css?v=5.4.3','./assets/emily-greeting-flow-v1.mp4');
CORE.push('./interactive-activity-engine.js?v=5.4.10');
CORE.push('./natural-voice.js?v=5.4.12','./interactive-activity-engine.js?v=5.4.12','./teacher-ai.js?v=5.4.5','./teacher-video-motion.js?v=5.4.7','./teacher-video-motion.css?v=5.4.11');
CORE.push('./teacher-modes-core.js?v=5.3.4','./teacher-ai.js?v=5.3.4','./app.js?v=5.3.4');
CORE.push('./google-ai-config.js?v=5.4.0','./google-ai-provider.js?v=5.4.0','./firebase-ai-logic-adapter.js?v=5.4.0','./teacher-providers.js?v=5.4.0','./GOOGLE_AI_SETUP_HE.md');
CORE.push('./teacher-rig.css?v=5.3.1','./teacher-system.js?v=5.4.3');
