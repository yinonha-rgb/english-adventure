const VERSION='english-adventure-4.4.3';
const CORE=['./','./index.html','./app.js?v=4.4.3','./teacher-modes-core.js?v=4.4.3','./firebase-sync.js?v=4.4.3','./teacher-ai.js?v=4.4.3','./firebase-config.js','./content.json','./manifest.json','./update-manifest.json','./icon.svg','./icon-maskable.svg'];
