const VERSION='english-adventure-4.1.0';
const CORE=['./','./index.html','./app.js?v=4.1.0','./teacher-modes-core.js?v=4.1.0','./firebase-sync.js?v=4.1.0','./teacher-ai.js?v=4.1.0','./firebase-config.js','./content.json','./manifest.json','./update-manifest.json','./icon.svg','./icon-maskable.svg'];
