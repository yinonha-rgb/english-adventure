const VERSION='english-adventure-4.20.6';
const CACHE_PREFIX='english-adventure-';
const CORE=['./','./index.html','./translations.js?v=4.20.6','./ui-controls.js?v=4.20.6','./answer-playback.js?v=4.20.6','./natural-voice.js?v=4.20.6','./teacher-visual.js?v=4.20.6','./teacher-system.js?v=4.20.6','./adaptive-learning.js?v=4.20.6','./daily-lesson-core.js?v=4.20.6','./interactive-activity-engine.js?v=4.20.6','./advanced-ai-config.js?v=4.20.6','./pricing-config.js?v=4.20.6','./advanced-ai-policy.js?v=4.20.6','./teacher-providers.js?v=4.20.6','./app.js?v=4.20.6','./teacher-modes-core.js?v=4.20.6','./firebase-sync.js?v=4.20.6','./teacher-ai.js?v=4.20.6','./firebase-config.js','./content.json','./manifest.json','./update-manifest.json','./icon.svg','./icon-maskable.svg','./assets/teacher-adam.png','./assets/teacher-noa.png'];
